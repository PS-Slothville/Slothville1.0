<script lang="ts">
    ...
    import NewMemoryGame from "./NewMemoryGame.svelte";
    import SuccessFailureScreen from "./SuccessFailureScreen.svelte";
    import NewScrambler from "./NewScrambler.svelte";
    import NewNumberMaze from "./NewNumberMaze.svelte";
    import NewNumberPuzzle from "./NewNumberPuzzle.svelte";
    import NewNumberUp from "./NewNumberUp.svelte";
    ...
    <div class="games-container">
        <div class="game-wrapper ps-bg-darkblue">
            ...
            <div class="main-game-body">
                ...
                {:else if $currentGameActive === GamesEnum.NumberUp}
                    <NewNumberUp on:game-ended={(event) => {showResultScreen = true; hackSuccess = event.detail.hackSuccess; }} />
                {/if}
            </div>
        </div>
    </div>
